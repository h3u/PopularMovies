...
import com.udacity.h3u.popularmovies.provider.base.BaseContentProvider;
...
public class PopularMoviesProvider extends BaseContentProvider {
    ...
    public static final String AUTHORITY = "com.udacity.h3u.popularmovies.provider";
    ...
    protected SQLiteOpenHelper createSqLiteOpenHelper() {
        return PopularMoviesSQLiteOpenHelper.getInstance(getContext());
    }
